...
const QuickSort = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-2">Quick Sort</h2>
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-yellow-300">O(n log n) average</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-white">Space Complexity:</span>
            <span className="text-sm text-green-300">O(log n)</span>
          </div>
        </div>
