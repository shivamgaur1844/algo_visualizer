...
const SelectionSort = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-2">Selection Sort</h2>
        <p className="text-blue-100 mb-4">
          Selection Sort divides the input list into a sorted and unsorted region, and repeatedly selects the smallest element from the unsorted region.
        </p>
        
        <div className="flex flex-wrap gap-4 mb-4">
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-white">Time Complexity:</span>
            <span className="text-sm text-yellow-300">O(n²)</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-white">Space Complexity:</span>
            <span className="text-sm text-green-300">O(1)</span>
          </div>
        </div>
