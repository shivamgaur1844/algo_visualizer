    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-blue-100 mb-4">
          Binary Search is an efficient algorithm for finding a target element in a sorted array by repeatedly dividing the search interval in half.
        </p>
        
        <div className="flex flex-wrap gap-4 mb-4">
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-white">Time Complexity:</span>
            <span className="text-sm text-yellow-300">O(log n)</span>
          </div>
          <div className="flex items-center space-x-2">
